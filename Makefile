.PHONY: devlog-update devlog-pr-body doc-automation-test web-dev web-test web-build web-pages
...
web-pages: ## Build the web client into the GitHub Pages /app route
